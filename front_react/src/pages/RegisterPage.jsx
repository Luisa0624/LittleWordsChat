  ...
  return (
    <div className='mt-5'>
      <div className='bg-white rounded w-full max-w-md overflow-hidden p-4 mx-auto'>
        <h3 className=' text-center items-center'>Bienvenido a Little Words Chat!</h3>
        ...
        <form className='grid gap-4 mt-5' onSubmit={handleSubmit}>
          ...
          <div className='flex flex-col gap-1'>
            ...
            <input 
              ...
              id='profile_pic'
              name='profile_pic'
              className='bg-slate-300 px-2 py-1 focus:outline-second hidden'
        ...
        <p className='my-3 text-center'>Ya tienes cuenta? <Link to={"/email"} className='hover:text-third font-semibold'>Login</Link></p>
      </div>
    </div>
  )
}
